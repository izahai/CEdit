...
COMPARISON_FIELDS = [
    ...
    "original_target_fid",
    "tgprs_target_fid",
    "original_non_target_clip_score",
    "tgprs_non_target_clip_score",
    "original_non_target_fid",
...
def load_training_configs(workflow_dir):
    ...
    with path.open(encoding="utf-8") as config_file:
        return {METHOD_TGPRS: yaml.safe_load(config_file)}
...
def build_comparison_rows(summary_rows, tasks):
    ...
    for task in tasks:
        ...
        comparisons.append({
            ...
            "tgprs_threshold": tgprs["threshold"],
            "tgprs_retain_scale": tgprs["retain_scale"],
            ...
            "original_target_fid": original["target_fid_mean"],
            "tgprs_target_fid": tgprs["target_fid_mean"],
            "original_non_target_clip_score": original[
                "non_target_clip_score_mean"
            ],
            "tgprs_non_target_clip_score": tgprs[
                "non_target_clip_score_mean"
            ],
            "original_non_target_fid": original["non_target_fid_mean"],
            ...
            "original_mscoco_fid": original["mscoco_fid_vs_original"],
